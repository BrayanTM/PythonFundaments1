...
#TODO LAB. Los fundamentos de las listas: Los Beatles
...
Escenario
Los Beatles fueron uno de los grupos de música más populares de la década de 1960 
y la banda más vendida en la historia. Algunas personas los consideran el acto más 
...
# paso 3
for i in range(2):
    member = input("Ingresa el nombre de los siguiente miembros de la banda: Stu Sutcliffe y Pete Best: ")
