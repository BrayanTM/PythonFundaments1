...
def enter_move(board):
    ...
    try:
        mov_user = int(input("Ingreasa tu movimiento: "))
        if mov_user < 1 or mov_user > 9:
            print("Movimiento fuera del rango establecido")
    except ValueError:
        print("El tipo de dato es incorrecto, por favor ingrese un numero entero")
