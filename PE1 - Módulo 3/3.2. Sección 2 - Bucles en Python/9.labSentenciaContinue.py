...
#TODO La sentencia continue - el Feo Devorador de Vocales

#? Escenario:

"""

La sentencia continue se usa para omitir el bloque actual y avanzar a la 
siguiente iteración, sin ejecutar las sentencias dentro del bucle.
...
- utiliza user_word = user_word.upper() para convertir la palabra ingresada 
  ...
  cadena y el método upper() muy pronto, no te preocupes
...
- imprime las letras no consumidas en la pantalla, cada una de ellas en una 
  línea separada
